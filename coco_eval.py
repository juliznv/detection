...
def evaluate_coco(img_path, set_name, image_ids, coco, model, threshold=0.05):
    ...
    # write output
    filepath = f'efficientdet_d{compound_coef}_{set_name}_bbox_results.json'
...
if __name__ == '__main__':
    ...
    _eval(coco_gt, image_ids, f'efficientdet_d{compound_coef}_{SET_NAME}_bbox_results.json')
